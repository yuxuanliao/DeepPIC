...
def Datatransform(file_csv_path, plot_csv_format):
    KPIC2_result = pd.read_csv(file_csv_path)
    KPIC2_result_format = KPIC2_result.drop(index=KPIC2_result.index[[0,1,2,3,4,5]])
    KPIC2_result_format = KPIC2_result_format.T
    KPIC2_result_format = KPIC2_result_format.drop(index=KPIC2_result_format.index[[0]])
    KPIC2_result_format.index.name = 'compound'
    KPIC2_result_format.columns = ['leaf-01', 'leaf-02', 'leaf-03', 'leaf-04', 'leaf-05', 'leaf-06', 'leaf-07', 'leaf-08',
                                   'leaf-09', 'leaf-10', 'seed-01','seed-02', 'seed-03', 'seed-04', 'seed-05', 'seed-06',
                                   'seed-07', 'seed-08', 'seed-09', 'seed-10']
    KPIC2_result_format.to_csv(plot_csv_format)
    data = pd.read_csv(plot_csv_format, encoding='gbk')
    return data
