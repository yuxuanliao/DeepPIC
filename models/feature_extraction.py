# -*- coding: utf-8 -*-
"""
Created on Thu Aug 18 14:16:44 2022
...
def get_array(choose_spec_r,np=np):
    ...
    N = np.unique(choose_spec_r[0][:,0])#注意间隔要改
    if ((256-len(N)) % 2) == 0:
...
if __name__ == '__main__':
    #xiaoshu
    path = 'D:/Dpic/data2/601/liver24_3.mzXML'
    ...
    p = Pool(5)
    array = p.map(get_array,choose_spec_r4)  #choosew_spec_r4 5 6
